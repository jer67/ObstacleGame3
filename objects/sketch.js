...
function draw(){
  ...
  if (died == false){
    ...
    if (frameCount % 90 == 0 && recovered == true) {
    ...
    if (frameCount % 60 == 0 && recovered == true) {
    ...
    if (frameCount % 80 == 0 && recovered == true) {
    ...
    background ("random")
    textSize(32);
    text('SPACE TO RESTART', 70, 150);
    fill(0,102,153)
    text('FINAL SCORE = '+score,70,210)
    fill("blue")
    if (scored == false){
